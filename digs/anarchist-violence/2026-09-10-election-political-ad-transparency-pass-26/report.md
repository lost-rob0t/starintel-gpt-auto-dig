...
- Google / Google Ads and the March 2026 Shopping Ads political-content verification update.
- Public company leadership nodes for Mark Zuckerberg, Evan Spiegel, Ronan Harris, and Steve Huffman.

## Evidence handling

First-party/current sources are preferred. Dated policy material is explicitly preserved as historical where current 2026 policy was not independently verified. No private advertiser dashboards, private audience data, individual voter targeting records, or inferred political preferences are collected. Relationships are limited to source-backed operational, ownership/operation, transparency-surface, or public leadership edges.

## Coverage

Packet contains 50 typed StarIntel v0.9 records:
