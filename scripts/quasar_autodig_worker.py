    ...
    def run_once(self, workspace_id: str) -> int:
        ...
        for candidate in self.control.list_runs(workspace_id, limit=self.list_limit):
            ...
            def should_continue() -> None:
                ...
                # The canonical public run projection intentionally strips worker
                # fencing fields. Validate ownership with the worker-only heartbeat
                # command instead of expecting lease material from autodig.run.get.
